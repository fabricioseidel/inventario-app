  ...
  const handleSaveSupplier = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        notes: form.notes,
        leadTimeDays:
          form.lead_time_days != null && form.lead_time_days !== ""
            ? Number(form.lead_time_days)
            : undefined,
        minOrderAmount:
          form.min_order_amount != null && form.min_order_amount !== ""
  ...
  const handleSaveAssignment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        priority: Number(assignmentForm.priority || 1),
        supplierSku: assignmentForm.supplierSku || undefined,
        packSize:
          assignmentForm.packSize !== ""
            ? Number(assignmentForm.packSize)
            : undefined,
        unitCost:
          assignmentForm.unitCost !== ""
            ? Number(assignmentForm.unitCost)
            : undefined,
        defaultReorderQty:
          assignmentForm.defaultReorderQty !== ""
            ...
            : undefined,
        reorderThreshold:
          assignmentForm.reorderThreshold !== ""
            ? Number(assignmentForm.reorderThreshold)
            : undefined,
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleFormChange("lead_time_days", e.target.value)
                    }
                  />
                </div>
                <div>
          ...
          {selectedId ? (
            <div className="bg-white border rounded-lg shadow-sm p-6 space-y-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Configura el proveedor preferido para cada producto, prioridad
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleAssignmentChange("priority", e.target.value)
                    }
                  />
                </div>
                <div>
                  ...
                  <input
                    className="mt-1 w-full rounded-md border border-gray-300 px-2 py-2 text-sm focus:border-blue-500 focus:ring-blue-500"
                    value={assignmentForm.supplierSku}
                    onChange={(e) =>
                      handleAssignmentChange("supplierSku", e.target.value)
                    }
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input
                    ...
                    min={0}
                    className="mt-1 w-full rounded-md border border-gray-300 px-2 py-2 text-sm focus:border-blue-500 focus:ring-blue-500"
                    value={assignmentForm.reorderThreshold}
                    onChange={(e) =>
                      handleAssignmentChange("reorderThreshold", e.target.value)
                    }
                  />
                </div>
                    ...
                    {assignments.map((assignment) => {
                      ...
                      return (
                        <tr key={`${assignment.product_id}-${assignment.supplier_id}`}>
                          ...
                          <td className="px-4 py-2">{assignment.priority}</td>
                          <td className="px-4 py-2">
