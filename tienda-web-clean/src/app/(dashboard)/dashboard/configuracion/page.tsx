    ...
    const saveSettings = async () => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Store timestamp in localStorage to trigger refresh across tabs
                try {
                    localStorage.setItem("settings:last_update", Date.now().toString());
                } catch { }
            ...
            <div className="bg-white border-b border-slate-200 sticky top-0 z-40 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        ...
                        {showSuccess && (
                            <div className="flex items-center gap-2 bg-green-50 border border-green-200 rounded-lg px-4 py-2 animate-pulse">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                    ...
                    <div className="lg:col-span-3">
                        <form onSubmit={handleSave} className="space-y-6">
                            {/* General */}
                            {activeTab === "general" && (
                                <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6 transition-all duration-300">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                                        <div className="pb-4 border-b border-slate-100 mb-6">
                                            ...
                                            <p className="text-sm text-slate-500 mt-1">Así se verán tus colores en la tienda</p>
                                        </div>

                                        <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 grid grid-cols-1 md:grid-cols-2 gap-8"
                                            style={{
                                                "--color-primary": settings.appearance?.primaryColor || "#10B981",
                                                "--color-secondary": settings.appearance?.secondaryColor || "#059669",
                                                "--color-accent": settings.appearance?.accentColor || "#047857",
                                                "--color-footer-bg": settings.appearance?.footerBackgroundColor || "#1F2937",
                                                "--color-footer-text": settings.appearance?.footerTextColor || "#F3F4F6",
                                            } as React.CSSProperties}
                                        >
                                            {/* Light Mode Preview */}
                                            <div className="space-y-4">
                                                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Componentes</h3>
                                                <div className="space-y-4">
                                                    <div className="flex flex-wrap gap-2">
                                                        <button className="px-5 py-2.5 rounded-xl font-semibold text-white bg-[var(--color-primary)] shadow-sm">
                                                            Botón Primario
                                                        </button>
                                                        <button className="px-5 py-2.5 rounded-xl font-semibold text-white bg-[var(--color-secondary)] shadow-sm">
                                                            Botón Secundario
                                                        </button>
                                                    </div>
                                                    <div className="flex flex-wrap gap-2">
                                                        <button className="px-5 py-2.5 rounded-xl font-semibold text-[var(--color-primary)] border-2 border-[var(--color-primary)] bg-transparent">
                                                            Outline
                                                        </button>
                                                        <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[var(--color-primary)] text-white/90">
                                                            Badge
                                                        </span>
                                                    </div>
                                                </div>

                                                <div className="p-4 bg-white rounded-xl shadow-sm border-l-4 border-[var(--color-accent)]">
                                                    <h4 className="font-semibold text-gray-900">Tarjeta de Ejemplo</h4>
                                                    <p className="text-sm text-gray-600 mt-1">Este es un elemento acentuado con tu color de énfasis.</p>
                                                </div>
                                            </div>

                                            {/* Footer Preview */}
                                            <div className="space-y-4">
                                                <h3 className="text-sm font-medium text-gray-500 uppercase tracking-wider">Footer</h3>
                                                <div className="p-6 rounded-xl bg-[var(--color-footer-bg)] text-[var(--color-footer-text)]">
                                                    <h4 className="font-bold text-lg mb-2">Mi Tienda</h4>
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
                                        <div className="pb-4 border-b border-slate-100">
                                            <h2 className="text-lg font-semibold text-slate-900">Colores de la Marca</h2>
                                            <p className="text-sm text-slate-500 mt-1">Define la paleta de colores principal</p>
                                        </div>
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
                                        <div className="pb-4 border-b border-slate-100">
                                            <h2 className="text-lg font-semibold text-slate-900">Estructura y Footer</h2>
                                            <p className="text-sm text-slate-500 mt-1">Colores para secciones estructurales</p>
                                        </div>

                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <ColorField
                                                label="Fondo del Footer"
                                                value={settings.appearance?.footerBackgroundColor || "#1F2937"}
                                                onChange={(val) => handleChange(["appearance", "footerBackgroundColor"], val)}
                                                description="Color de fondo para el pie de página."
                                            />
                                            <ColorField
                                                label="Texto del Footer"
                                                value={settings.appearance?.footerTextColor || "#F3F4F6"}
                                                onChange={(val) => handleChange(["appearance", "footerTextColor"], val)}
                                                description="Color de texto para el pie de página."
                                            />
                                        </div>
                                    </div>
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 space-y-6">
                                        <div className="pb-4 border-b border-slate-100">
                                            <h2 className="text-lg font-semibold text-slate-900">Imágenes y Logos</h2>
                                            <p className="text-sm text-slate-500 mt-1">Recursos gráficos de la tienda</p>
                                        </div>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <InputField
                                                ...
                                                hint="Recomendado: PNG transparente, 200px ancho"
                                            />
                                            <InputField
                                                ...
                                                hint="Formato .ico o .png, 32x32px"
                                            />
                                        </div>
                                        ...
                                        <div className="border-t border-slate-100 pt-6">
                                            <div className="flex items-center justify-between mb-4">
                                                <div>
                                                    <h3 className="font-medium text-slate-900">Banner Principal</h3>
                                                    <p className="text-sm text-slate-500">Imagen grande en la página de inicio</p>
                                                </div>
                                                <CheckBoxField
                                                    label="Habilitar"
                                                    ...
                                                    onChange={() => {
                                                        if (settings.appearance?.bannerUrl) {
                                                            ...
                                                            handleChange(["appearance", "bannerUrl"], "/placeholder-banner.jpg");
                                                        }
                                                    }}
                                                />
                                            </div>
                                            ...
                                            {settings.appearance?.bannerUrl && (
                                                <div className="space-y-4">
                                                    <div className="relative w-full h-48 rounded-lg overflow-hidden border border-slate-200 bg-slate-50 shadow-inner group">
                                                        <div
                                                        ...
                                                        onChange={async (dataUrl) => {
                                                            try {
                                                                if (dataUrl.startsWith("data:image")) {
                                                                    // Simular subida o manejar lógica real si existe el endpoint
                                                                    ...
                                                                    if (resp.ok) {
                                                                        ...
                                                                        if (json?.url) handleChange(["appearance", "bannerUrl"], json.url);
                                                                    }
                                                                } else {
                                    ...
                                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                                        <CheckBoxField
                                            label="Habilitar Modo Oscuro (Beta)"
                                        ...
                                        <p className="text-xs text-slate-500 mt-2 ml-7">
                                            Permite a los usuarios cambiar entre tema claro y oscuro en la tienda. asegúrate de que tus colores funcionen bien en ambos modos.
                                        </p>
                                    </div>
                                </div>
                            )}
                                        ...
                                        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                            ...
                                            <p className="text-sm text-amber-700 mt-2 ml-7">
                                                {settings.paymentTestMode
                                                    ? "✓ Los pagos serán simulados, no se procesarán realmente. Ideal para desarrollo."
                                                    : "⚠️ Los pagos se procesarán realmente. Asegúrate de tener tus credenciales configuradas."}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex justify-end gap-3 pt-6 sticky bottom-6 z-30">
                                <div className="bg-white/80 backdrop-blur-sm p-2 rounded-lg shadow-lg border border-slate-200 flex gap-3">
                                    {isAdmin ? (
                                        <>
                                            <Button variant="outline" onClick={loadSettings} type="button">
                                                Recargar
                                            </Button>
                                            <Button
                                                type="submit"
                                        ...
                                        <div className="text-sm text-slate-500 py-2 px-2">Solo administradores pueden editar la configuración.</div>
                                    )}
                                </div>
                            </div>
                        </form>
        ...
        <div>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    maxLength={maxLength}
                    className={`w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition ${prefix ? "pl-7" : ""
                        } ${suffix ? "pr-12" : ""}`}
                />
...
function CheckBoxField({ label, checked, onChange }: CheckBoxFieldProps) {
    return (
        <label className="flex items-center gap-3 cursor-pointer p-3 rounded-lg hover:bg-slate-50 transition border border-transparent hover:border-slate-200">
            <input
                type="checkbox"
                checked={checked}
        ...
        <div>
            ...
            <div className="flex items-center gap-3">
                <input
                    ...
                    value={value}
                    onChange={(e) => onChange(e.target.value)}
                    className="w-12 h-10 border border-slate-300 rounded-lg cursor-pointer p-1"
                />
                <input
                    type="text"
                    value={value}
                    onChange={(e) => onChange(e.target.value)}
                    className="flex-1 px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-transparent outline-none transition text-sm font-mono"
                />
            </div>
